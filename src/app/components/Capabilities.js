...
export default function Capabilities() {
  return (
    <div className="mt-16 md:px-28 px-6 flex flex-col items-center">
      <h2 className="capitalize md:text-sm text-xs text-[#B9FD50]">OUR CAPABILITIES</h2>
      <p className="md:text-4xl text-2xl mt-2 font-bold">We can help you with...</p>
